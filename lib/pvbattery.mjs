...
class PVBattery {
	 ...
	 * @param {number} soc - The State of Charge (SOC) of the battery in percent.
	 * @returns {object[]} An array of objects with idx, price, soc, level, charge, grid, pv, consumption, lockDischarging, and lockCharging properties.
	 */
